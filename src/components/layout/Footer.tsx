...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{ borderColor: "var(--color-border)", background: "var(--nav-bg)", backdropFilter: "blur(16px)" }}
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <div
              ...
              style={{ background: "var(--code-bg)", borderColor: "var(--color-border)" }}
            >
              ...
              <p className="text-text-muted text-xs font-mono mt-0.5">
                ...
                <span className="text-primary">&quot;VitalHub Innovations Lab&quot;</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-text-muted text-sm flex items-center gap-1">
            Built with <Heart className="w-3.5 h-3.5 text-red-500 fill-current" /> by Abhishek Peiris · {new Date().getFullYear()}
          </p>
          <p className="text-text-muted text-xs font-mono">
