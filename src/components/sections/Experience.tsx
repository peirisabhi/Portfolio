...
export default function Experience() {
  return (
    <SectionWrapper id="experience" tag="03. experience" className="bg-gradient-to-b from-bg-elevated/30 to-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="section-subheading">My professional journey and the impact I&apos;ve made.</p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            >
              <div className="relative glass-card p-8 overflow-hidden group">
                ...
                <div
                  ...
                  style={{ background: `radial-gradient(circle, ${exp.color}06 0%, transparent 70%)`, transform: "translate(30%, -30%)" }}
                />
                {/* Left accent */}
                <div
                ...
                <div className="pl-4">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        <div
                          ...
                          style={{ background: exp.color + "18", boxShadow: `0 0 20px ${exp.color}18` }}
                        >
                          <Briefcase className="w-5 h-5" style={{ color: exp.color }} />
                        </div>
                        <div>
                          <h3 className="font-heading font-bold text-xl text-text-primary">{exp.role}</h3>
                      ...
                      <div className="flex flex-wrap gap-4 text-sm text-text-muted">
                        <div className="flex items-center gap-1.5">
                          <Calendar className="w-4 h-4 text-secondary" /><span>{exp.period}</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          <MapPin className="w-4 h-4 text-accent" /><span>{exp.location}</span>
                        </div>
                      </div>
                    </div>
                    {exp.current && (
                  ...
                  <div className="mb-6">
                    <h4 className="font-heading font-semibold text-text-primary text-sm mb-3 flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-accent" />Key Achievements
                    </h4>
                  ...
                  <div>
                    <h4 className="font-heading font-semibold text-text-primary text-sm mb-3">Technologies Used</h4>
                    <div className="flex flex-wrap gap-2">
                      {exp.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="px-3 py-1 rounded-lg text-xs font-mono border"
                          style={{ borderColor: exp.color + "28", color: exp.color, background: exp.color + "08" }}
                        >
                          {tech}
                        </span>
                      ))}
          ...
          >
            <div className="relative z-10">
              ...
              <h3 className="font-heading font-bold text-xl text-text-primary mb-2">Open to New Opportunities</h3>
              <p className="text-text-secondary max-w-md mx-auto mb-6">
                I&apos;m always excited to explore new challenges and innovative projects. Let&apos;s build something amazing together.
              </p>
              <button
