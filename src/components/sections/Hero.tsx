      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-6 items-center min-h-screen py-24">
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl font-bold mb-3 leading-tight">
                Hi, I&apos;m{" "}
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              ...
              >
                <div
                  className="w-3 h-3 rounded-full bg-primary shadow-glow-primary"
